            ...
            <div class="row">
              <div class="col-lg-6 offset-lg-3">
                ...
                <div class="form-group">
                  ...
                  <div class="text-warning">You cannot upadate Email Address from here, you can update it from <a class="text-" href="{{route('admin.basicinfo') . '?language=' . request()->input('language')}}"><u>Basic Settings > Basic Informations</u></a></p></div>
                </div>
                <div class="form-group">
