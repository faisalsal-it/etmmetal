           ...
           <div class="col-lg-7">
              <div class="job-details">
                ...
                <div class="info">
                    ...
                    <div class="desc">
                        {!! convertUtf8($job->job_responsibilities) !!}
                    </div>
                </div>
                @endif
                ...
                <div class="info">
                    ...
                    <div class="desc">
                        {!! convertUtf8($job->educational_requirements) !!}
                    </div>
                </div>
                @endif
                ...
                <div class="info">
                    ...
                    <div class="desc">
                        {!! convertUtf8($job->experience_requirements) !!}
                    </div>
                </div>
                @endif
                ...
                <div class="info">
                    ...
                    <div class="desc">
                        {!! convertUtf8($job->additional_requirements) !!}
                    </div>
                </div>
                @endif
                ...
                <div class="info">
                    ...
                    <div class="desc">
                        {!! convertUtf8($job->read_before_apply) !!}
                    </div>
                </div>
                @endif
